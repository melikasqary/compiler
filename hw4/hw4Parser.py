...
class hw4Parser ( Parser ):
    ...
    class PasswordContext(ParserRuleContext):
        ...
        def CHAR(self, i:int=None):
            if i is None:
                return self.getTokens(hw4Parser.CHAR)
            else:
                return self.getToken(hw4Parser.CHAR, i)

        def getRuleIndex(self):
            return hw4Parser.RULE_password
    ...
    def password(self):
        ...
        localctx = hw4Parser.PasswordContext(self, self._ctx, self.state)
